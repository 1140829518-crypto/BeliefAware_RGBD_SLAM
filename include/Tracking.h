...
protected:
   ...
   /**
    ...
    /**
     * @brief 清理当前帧中已达到动态抑制阈值的 MapPoint，并输出语义动态日志
     * @details Semantic Dynamic Probability Accumulation 的最终抑制步骤
     */
    void CullSemanticDynamicMapPoints();

    /**
     * @brief 构建并更新对象级语义地图
     */
    void UpdateSemanticObjectMap();
