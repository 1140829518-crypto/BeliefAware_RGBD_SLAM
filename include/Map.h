...
public:
    ...
    SemanticObject* AddOrFuseSemanticObject(SemanticObject* pObj, const float &distTh = 0.6f);
    vector<SemanticObject*> GetAllSemanticObjects();
    void SaveSemanticObjects(const std::string &filename);
    size_t SemanticObjectsInMap();
    ...
    std::set<SemanticObject*> mspSemanticObjects;
