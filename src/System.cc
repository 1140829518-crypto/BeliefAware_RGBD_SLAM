...
void System::SaveSemanticObjects(const string &filename)
{
    cout << endl << "Saving semantic objects to " << filename << " ..." << endl;
    mpMap->SaveSemanticObjects(filename);
    cout << endl << "semantic objects saved!" << endl;
}

void System::SaveSemanticDynamicStatistics(const string &filename)
{
    cout << endl << "Saving semantic dynamic statistics to " << filename << " ..." << endl;
    mpTracker->SaveSemanticDynamicStatistics(filename);
    cout << endl << "semantic dynamic statistics saved!" << endl;
}
...
void System::SaveKeyFrameTrajectoryEuroc(const string &filename)//zt1
{
    cout << endl << "Saving keyframe trajectory to " << filename << " ..." << endl;
...
ORB_SLAM2::Frame ORB_SLAM2::System::GetTrackingFrame()//zt为了保存图片新增
{
